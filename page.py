...
class TestPage(Assertions):
    ...
    def master_test_case(self):
        ...
        self.clickElementByXPATH(td.my_call_box_xpath)
        self.pause(1)
        self.clickElementByXPATH(td.sharescreen_xpath)
        # self.switch_to_window(0)
        self.pause(5)
        self.send_keys_function(td.sharescreen_xpath, "TAB")
        self.pause(1)
        self.send_keys_function(td.sharescreen_xpath, "TAB")
        self.pause(1)
        self.send_keys_function(td.sharescreen_xpath, "TAB")
        ...
        self.send_keys_function(td.sharescreen_xpath, "TAB")
        self.pause(1)
        self.send_keys_function(td.sharescreen_xpath, "RIGHT")
        self.pause(1)
        self.send_keys_function(td.sharescreen_xpath, 'TAB')
        self.pause(1)
        self.send_keys_function(td.sharescreen_xpath, 'TAB')
        ...
        self.send_keys_function(td.sharescreen_xpath, 'TAB')
        self.pause(1)
        self.send_keys_function(td.sharescreen_xpath, 'DOWN')
        self.pause(1)
        self.send_keys_function(td.sharescreen_xpath, 'DOWN')
        self.pause(1)
        self.send_keys_function(td.sharescreen_xpath, 'RETURN')
        self.pause(1)
        self.switch_to_window(0)
        self.pause(5)
        self.switch_to_iframe_using_css(td.iframe_css)
